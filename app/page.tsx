...
export const metadata: Metadata = {
  ...
  description: "Join the best IoT and Robotics training institute in Nepal. Nepatronix offers expert-led workshops for schools covering Arduino, PCB Design, and Electronics.",
};
...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="mx-auto mt-24 max-w-6xl space-y-12 px-6" id="about">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-xl leading-relaxed text-[#6B7280]">
            <span className="font-semibold text-[#020617]">NepaTronix</span> is a leading Nepal-based IOT, STEM EdTech and software company dedicated to bridging the persistent gap between theoretical knowledge and real-world innovation. Founded in <span className="font-semibold text-[#2563EB]">2021</span>, the company is driven by the core belief that education should inspire creativity, cultivate practical skills, and lead to meaningful invention. As a multidisciplinary technology enterprise, NepaTronix operates across the intersections of <span className="text-[#020617]">engineering</span>, <span className="text-[#020617]">education</span>, and <span className="text-[#020617]">social impact</span>—delivering smart technology solutions and engaging educational programs that empower learners of all backgrounds.
          </p>
        </div>
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm hover:shadow-[0_4px_20px_rgba(2,6,23,0.1)] transition-all hover:border-[#020617]/20">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#020617]/10 px-4 py-2">
              ...
              <span className="text-sm font-semibold uppercase tracking-widest text-[#020617]">Vision</span>
            </div>
            <p className="text-lg leading-relaxed text-slate-700">
              &ldquo;Tech-driven learning that inspires innovation at every level.&rdquo;
            </p>
          </div>
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm hover:shadow-[0_4px_20px_rgba(193,18,31,0.15)] transition-all hover:border-[#C1121F]/20">
            ...
            <p className="text-lg leading-relaxed text-slate-700">
              &ldquo;To simplify and amplify IoT, STEM education through impactful tools, creative content, and innovating real-world technology.&rdquo;
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto mt-24 max-w-6xl space-y-12 px-6" id="programs">
        <SectionHeading
      ...
      <section className="mx-auto mt-24 max-w-6xl space-y-12 px-6" id="mentors">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            >
              <div className={`mb-6 flex h-20 w-20 items-center justify-center rounded-2xl ${service.color}`}>
      ...
      <section className="mx-auto mt-24 max-w-6xl space-y-12 px-6" id="portfolio">
        <SectionHeading
      ...
      <section className="mx-auto mt-24 mb-24 max-w-6xl space-y-12 px-6" id="testimonials">
        <SectionHeading
            ...
            {[
              ...
              >
                ...
                <div className="border-t border-[#e3f2fd] pt-4">
                  <p className="font-semibold text-[#1f2933]">{testimonial.name}</p>
