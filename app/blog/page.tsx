...
export default function BlogPage() {
  ...
  // Helper to truncate text to ~40 words
        ...
        {!isSearchActive ? (
          <>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 mb-20">
              {/* Left: Featured Post */}
              <Link href={`/blog/${featuredPost.slug.current}`} className="lg:col-span-2 group cursor-pointer relative block">
                <div className="relative aspect-video w-full overflow-hidden rounded-3xl shadow-xl shadow-slate-200">
                  <div className="absolute inset-0 bg-linear-to-t from-[#020617]/90 via-[#020617]/20 to-transparent z-10 opacity-80 transition-opacity duration-500 group-hover:opacity-70" />
                  <Image
                  ...
                  <div className="absolute bottom-0 left-0 p-8 z-20">
                    ...
                    <p className="text-gray-300 text-sm mb-6 line-clamp-3 max-w-2xl">
                      {truncateText(featuredPost.excerpt, 40)}
                    </p>
              ...
              <div className="lg:col-span-1 flex flex-col justify-between space-y-8">
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 h-full">
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <Link href="/blog" className="text-xs font-bold text-[#C1121F] hover:underline cursor-pointer">View All</Link>
                    </div>
          ...
          <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <h1 className="text-3xl font-extrabold text-[#020617] tracking-tight sm:text-4xl">
              ...
              <span className="text-slate-400 font-medium ml-2 text-2xl font-sans italic">for &quot;{searchQuery}&quot;</span>
            </h1>
            <button 
              onClick={() => setSearchQuery("")}
              className="mt-6 flex items-center gap-2 text-sm font-bold text-[#C1121F] hover:text-[#A30F19] transition-colors group"
            >
            ...
            return (
              <Link href={`/blog/${post.slug.current}`} key={post._id} className="group flex flex-col h-full bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 border border-slate-100">
                <div className="relative aspect-video w-full overflow-hidden bg-slate-100">
                  ...
                  />
                  <div className="absolute inset-x-0 bottom-0 h-1/2 bg-linear-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                </div>
                ...
                <div className="flex flex-col flex-1 p-8">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed mb-6 line-clamp-4">
                   {truncateText(post.excerpt || "Explore the latest updates and insights from Nepatronix about technology and innovation in Nepal.", 40)}
                  </p>
