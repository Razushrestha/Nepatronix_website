        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex w-full max-w-lg mx-auto items-center gap-2">
            <div className="relative flex-1 group">
              ...
              />
              <svg
                className="absolute left-4 top-3 h-5 w-5 text-gray-500 group-focus-within:text-[#C1121F] transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-20 bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200">
            ...
            <button
              ...
              className="mt-4 text-[#C1121F] text-sm font-semibold hover:underline"
            >
              Clear search
            </button>
          </div>
