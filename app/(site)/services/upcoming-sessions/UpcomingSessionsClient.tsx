                    ...
                    {activeTab === 'upcoming' ? (
                      <>
                        ...
                        {session.registrationLink ? (
                          <a
                            href={isFull || deadlinePassed ? undefined : session.registrationLink}
                            target="_blank"
                            rel="noopener noreferrer"
                            onClick={(e) => (isFull || deadlinePassed) && e.preventDefault()}
                          ...
                          >
                            ...
                            {isFull ? "Session Full" : deadlinePassed ? "Deadline Passed" : "Register Now"}
                          </a>
                        ) : (
                          <button
