    ...
    fields: [
      {
        ...
        type: 'text',
        required: true,
        help: 'Reviewer name as shown on the homepage Client Reviews marquee',
      },
      {
        name: 'role',
        label: 'Role / Source',
        type: 'text',
        help: 'e.g. Student · Google Review, Client · Google Review',
      },
      {
        name: 'rating',
        label: 'Rating (1-5)',
        type: 'number',
        help: 'Star rating shown on the review card (usually 5)',
      },
      {
        name: 'review',
        label: 'Review',
        type: 'textarea',
        fullWidth: true,
        help: 'Full review text from Google (keep concise for the marquee)',
      },
      {
        name: 'order',
        label: 'Display Order',
        type: 'number',
        help: 'Lower numbers appear first in the Client Reviews section',
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: 'text',
        required: true,
        help: 'Shown on the homepage services grid',
      },
      {
        name: 'description',
        label: 'Description',
        type: 'textarea',
        fullWidth: true,
        help: 'One short line under the title',
      },
      {
        name: 'href',
        label: 'Link URL',
        type: 'text',
        placeholder: '/services/stem-education',
        help: 'Public service page path, e.g. /services/institutional-programs',
      },
      {
        name: 'iconKey',
        label: 'Icon',
