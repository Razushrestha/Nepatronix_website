...
`, VersionModeHeader = (t0) => {
  ...
  let t2;
  $[2] !== documentVersions ? (t2 = documentVersions.flatMap(_temp$I), $[2] = documentVersions, $[3] = t2) : t2 = $[3];
...
`, DiffViewPane = forwardRef(function(t0, ref) {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = useState(_temp$G);
  let t2;
...
function PaneLayout(props) {
  ...
  const [controller] = useState(_temp$F), [rootElement, setRootElement] = useState(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
`, CANVAS_IMAGE_URL = "https://cdn.sanity.io/images/pyrmmpch/production/b47224e2f3a7d1747e43b9da1ac31739250e628b-632x376.png", CANVAS_APP_NAME = "Canvas", CanvasPopoverContent = (t0) => {
  ...
  let t2;
  $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t2 = () => setOpen(_temp$z), $[8] = t2) : t2 = $[8];
...
`, FormHeader = (t0) => {
  ...
  const $ = c(77), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = useState(_temp$y), isLocked = editState?.transactionSyncLock?.enabled, {
    t
  } = useTranslation(structureLocaleNamespace);
  let t0;
