 ...
 * @internal
 */
export declare const getVersionInlineBadge: (release?: TargetPerspective) => FC<{
 ...
 * @internal
 */
export declare function isPausedCardinalityOneRelease(release: ReleaseDocument | undefined): boolean
 ...
 * @hidden
 */
export declare const useCopyPaste: () => {}
 ...
 * ```
 */
export declare function useGetFormValue(): {}
 ...
 * @internal
 */
export declare function usePausedScheduledDraft(): {
  isPaused: boolean
 ...
 * @internal
 */
export declare function useReferenceInputOptions(): unknown
 ...
 * @internal
 */
export declare function useScheduledDraftDocument(
