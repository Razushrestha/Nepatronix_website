...
import * as xstate951 from "xstate";
import { ActorRefFrom } from "xstate";
import * as rxjs8 from "rxjs";
import { Mutation, NodePatchList } from "@sanity/mutate";
declare const createDocumentMutator: (comlink: VisualEditingNode) => xstate951.StateMachine<{
  client: SanityClient;
  ...
  [x: string]: xstate951.ActorRefFromLogic<xstate951.PromiseActorLogic<void | _sanity_client764.SanityDocument<Record<string, any>> | undefined, {
    client: SanityClient;
    id: string;
  }, xstate951.EventObject>> | xstate951.ActorRefFromLogic<xstate951.PromiseActorLogic<void, {
    client: SanityClient;
    transactions: _sanity_mutate__unstable_machine296.Transaction[];
  }, xstate951.EventObject>> | xstate951.ActorRefFromLogic<xstate951.ObservableActorLogic<_sanity_client764.ReconnectEvent | _sanity_client764.WelcomeEvent | _sanity_client764.MutationEvent, {
    listener: ReturnType<typeof _sanity_mutate__unstable_machine296.createSharedListener>;
    id: string;
  }, xstate951.EventObject>> | undefined;
  getDocument?: xstate951.ActorRefFromLogic<xstate951.PromiseActorLogic<void | _sanity_client764.SanityDocument<Record<string, any>> | undefined, {
    client: SanityClient;
    id: string;
  }, xstate951.EventObject>> | undefined;
  submitTransactions?: xstate951.ActorRefFromLogic<xstate951.PromiseActorLogic<void, {
    client: SanityClient;
    transactions: _sanity_mutate__unstable_machine296.Transaction[];
  }, xstate951.EventObject>> | undefined;
}, xstate951.Values<{
  'fetch remote snapshot': {
    ...
    logic: xstate951.PromiseActorLogic<void | _sanity_client764.SanityDocument<Record<string, any>> | undefined, {
      client: SanityClient;
      id: string;
    }, xstate951.EventObject>;
    id: "getDocument";
  };
  'submit mutations as transactions': {
    src: "submit mutations as transactions";
    logic: xstate951.PromiseActorLogic<void, {
      client: SanityClient;
      transactions: _sanity_mutate__unstable_machine296.Transaction[];
    }, xstate951.EventObject>;
  ...
  'server-sent events': {
    ...
    logic: xstate951.ObservableActorLogic<_sanity_client764.ReconnectEvent | _sanity_client764.WelcomeEvent | _sanity_client764.MutationEvent, {
      listener: ReturnType<typeof _sanity_mutate__unstable_machine296.createSharedListener>;
      id: string;
    }, xstate951.EventObject>;
    id: string | undefined;
  ...
  'assign error to context': {
    ...
    params: xstate951.NonReducibleUnknown;
  };
...
}, "error" | "busy" | "ready", _sanity_mutate__unstable_machine296.DocumentMutatorMachineInput, xstate951.NonReducibleUnknown, xstate951.EventObject, xstate951.MetaObject, {
  ...
  readonly context: ({
    ...
    spawn: {
      <TSrc extends "fetch remote snapshot" | "submit mutations as transactions" | "server-sent events">(logic: TSrc, ...[options]: ({
        ...
        src: TSrc;
      } ? xstate951.ConditionalRequired<[options?: ({
        id?: T["id"] | undefined;
        systemId?: string;
        input?: xstate951.InputFrom<T["logic"]> | undefined;
        syncSnapshot?: boolean;
      } & { [K in xstate951.RequiredActorOptions<T>]: unknown }) | undefined], xstate951.IsNotNever<xstate951.RequiredActorOptions<T>>> : never : never : never) | ({
        src: "submit mutations as transactions";
        logic: xstate951.PromiseActorLogic<void, {
          client: SanityClient;
          transactions: _sanity_mutate__unstable_machine296.Transaction[];
        ...
        id?: T_1["id"] | undefined;
        systemId?: string;
        input?: xstate951.InputFrom<T_1["logic"]> | undefined;
        syncSnapshot?: boolean;
      } & { [K_1 in xstate951.RequiredActorOptions<T_1>]: unknown }) | undefined], xstate951.IsNotNever<xstate951.RequiredActorOptions<T_1>>> : never : never : never) | ({
        src: "server-sent events";
        logic: xstate951.ObservableActorLogic<_sanity_client764.ReconnectEvent | _sanity_client764.WelcomeEvent | _sanity_client764.MutationEvent, {
          listener: ReturnType<typeof _sanity_mutate__unstable_machine296.createSharedListener>;
          id: string;
        ...
        id?: T_2["id"] | undefined;
        systemId?: string;
        input?: xstate951.InputFrom<T_2["logic"]> | undefined;
        syncSnapshot?: boolean;
      } & { [K_2 in xstate951.RequiredActorOptions<T_2>]: unknown }) | undefined], xstate951.IsNotNever<xstate951.RequiredActorOptions<T_2>>> : never : never : never)): xstate951.ActorRefFromLogic<xstate951.GetConcreteByKey<xstate951.Values<{
        "fetch remote snapshot": {
          src: "fetch remote snapshot";
          logic: xstate951.PromiseActorLogic<void | _sanity_client764.SanityDocument<Record<string, any>> | undefined, {
            client: SanityClient;
      ...
      <TLogic extends xstate951.AnyActorLogic>(src: TLogic, options?: {
        id?: never;
        systemId?: string;
        input?: xstate951.InputFrom<TLogic> | undefined;
        syncSnapshot?: boolean;
      } | undefined): xstate951.ActorRefFromLogic<TLogic>;
    };
    input: _sanity_mutate__unstable_machine296.DocumentMutatorMachineInput;
    self: xstate951.ActorRef<xstate951.MachineSnapshot<{
      client: SanityClient;
      sharedListener?: ReturnType<typeof _sanity_mutate__unstable_machine296.createSharedListener>;
      id: string;
      cache?: Map<string, _sanity_client764.SanityDocument<DocumentType> | null>;
      ...
      type: "xstate.done.actor.submitTransactions";
      output: undefined;
    }, Record<string, xstate951.AnyActorRef | undefined>, xstate951.StateValue, string, unknown, any, any>, _sanity_client764.ReconnectEvent | _sanity_client764.WelcomeEvent | _sanity_client764.MutationEvent | {
      type: "error";
    } | {
      type: "retry";
    } | {
          ...
          readonly invoke: {
            ...
            readonly input: ({
              ...
              self: xstate951.ActorRef<xstate951.MachineSnapshot<{
                ...
                type: "xstate.done.actor.submitTransactions";
                output: undefined;
              }, Record<string, xstate951.AnyActorRef>, xstate951.StateValue, string, unknown, any, any>, _sanity_client764.ReconnectEvent | _sanity_client764.WelcomeEvent | _sanity_client764.MutationEvent | {
                type: "error";
              } | {
                type: "retry";
              } | {
...
declare const createDatasetMutator: (comlink: VisualEditingNode) => xstate951.StateMachine<{
  client: SanityClient;
  /** A shared listener can be provided, if not it'll be created using `client.listen()` */
  sharedListener?: ReturnType<typeof createSharedListener>;
  ...
  [x: string]: xstate951.ActorRefFromLogic<xstate951.StateMachine<{
    client: SanityClient;
    sharedListener?: ReturnType<typeof createSharedListener>;
    id: string;
    cache?: Map<string, _sanity_client764.SanityDocument<DocumentType> | null>;
  ...
  }, "error" | "busy" | "ready", DocumentMutatorMachineInput, xstate951.NonReducibleUnknown, xstate951.EventObject, xstate951.MetaObject, {
    readonly id: "document-mutator";
    readonly context: ({
      input
    }: {
  ...
  params: xstate951.NonReducibleUnknown;
}, never, never, "pristine", string, DatasetMutatorMachineInput, xstate951.NonReducibleUnknown, {
  type: "sync";
  id: string;
  document: _sanity_mutate__unstable_machine296.SanityDocumentBase;
} | {
