...
import { useEffect, createContext, useContext, useState, memo, useRef, startTransition, useId, Fragment as Fragment$1, isValidElement, useSyncExternalStore, useDeferredValue, useReducer } from "react";
...
const ElementOverlayInner = (props) => {
  ...
  let t11;
  $[35] !== comlink || $[36] !== draggable || $[37] !== handleLabelClick || $[38] !== icon || $[39] !== menuId || $[40] !== nodePluginCollections || $[41] !== onActivateExclusivePlugin || $[42] !== onMenuOpenChange || $[43] !== showMenu || $[44] !== title ? (t11 = (title || showMenu) && /* @__PURE__ */ jsx(Tab, { gap: 1, paddingY: 1, onClick: handleLabelClick, children: /* @__PURE__ */ jsxs(Labels, { gap: 2, padding: 2, children: [
...
function Overlays(props) {
  ...
  }, t3 = [comlink], $[1] = comlink, $[2] = t2, $[3] = t3) : (t2 = $[2], t3 = $[3]), useEffect(t2, t3), usePerspectiveSync(comlink, dispatch);
  let t4, t5;
  $[4] !== onPerspectiveChange || $[5] !== perspective ? (t4 = () => {
    if (!onPerspectiveChange)
      return;
    const raf = requestAnimationFrame(() => startTransition(() => onPerspectiveChange(perspective)));
    return () => cancelAnimationFrame(raf);
  }, t5 = [onPerspectiveChange, perspective], $[4] = onPerspectiveChange, $[5] = perspective, $[6] = t4, $[7] = t5) : (t4 = $[6], t5 = $[7]), useEffect(t4, t5), useReportDocuments(comlink, elements, perspective);
  let t6;
  $[8] !== rootElement ? (t6 = (x, y) => {
  ...
  }, $[8] = rootElement, $[9] = t6) : t6 = $[9];
  const updateDragPreviewCustomProps = t6;
  let t7, t8;
  $[10] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t7 = () => {
  ...
  }, t10 = [overlayEnabled], $[12] = overlayEnabled, $[13] = t10, $[14] = t9) : (t10 = $[13], t9 = $[14]), useEffect(t9, t10);
  let t11;
  $[15] !== elements ? (t11 = elements.flatMap(_temp9), $[15] = elements, $[16] = t11) : t11 = $[16];
  const documentIds = t11;
  let t12;
  $[17] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = () => {
    dispatch({
      type: "overlay/blur"
    });
  }, $[17] = t12) : t12 = $[17];
  const closeContextMenu = t12, optimisticActorReady = useOptimisticActorReady(), componentResolver = optimisticActorReady ? _componentResolver : void 0, [shouldHideActions, setShouldHideActions] = useState(!1);
  !shouldHideActions && inFrame && comlinkStatus === "connected" && setShouldHideActions(!0);
  let t13;
  bb0: {
    if (isDragging) {
      let t143;
      $[18] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t143 = [], $[18] = t143) : t143 = $[18], t13 = t143;
      break bb0;
    }
    let t142;
    $[19] !== comlink || $[20] !== componentResolver || $[21] !== dragMinimapTransition || $[22] !== dragShowMinimap || $[23] !== elements || $[24] !== inFrame || $[25] !== isDragging || $[26] !== optimisticActorReady || $[27] !== props.plugins || $[28] !== shouldHideActions || $[29] !== wasMaybeCollapsed ? (t142 = elements.filter(_temp0).map((t152) => {
      const {
        id,
        element: element_0,
        focused,
    ...
    }), $[19] = comlink, $[20] = componentResolver, $[21] = dragMinimapTransition, $[22] = dragShowMinimap, $[23] = elements, $[24] = inFrame, $[25] = isDragging, $[26] = optimisticActorReady, $[27] = props.plugins, $[28] = shouldHideActions, $[29] = wasMaybeCollapsed, $[30] = t142) : t142 = $[30], t13 = t142;
  }
  const elementsToRender = t13, t14 = prefersDark ? "dark" : "light", t15 = fadingOut ? "" : void 0, t16 = overlaysFlash ? "" : void 0;
  let t17;
  $[31] !== documentIds || $[32] !== perspective ? (t17 = /* @__PURE__ */ jsx(DocumentReporter, { documentIds, perspective }), $[31] = documentIds, $[32] = perspective, $[33] = t17) : t17 = $[33];
  let t18;
  $[34] !== comlink || $[35] !== inFrame || $[36] !== inPopUp || $[37] !== overlayEnabled || $[38] !== rootElement || $[39] !== updateDragPreviewCustomProps ? (t18 = /* @__PURE__ */ jsx(OverlaysController, { comlink, dispatch, inFrame, inPopUp, onDrag: updateDragPreviewCustomProps, overlayEnabled, rootElement }), $[34] = comlink, $[35] = inFrame, $[36] = inPopUp, $[37] = overlayEnabled, $[38] = rootElement, $[39] = updateDragPreviewCustomProps, $[40] = t18) : t18 = $[40];
  let t19;
  $[41] !== contextMenu ? (t19 = contextMenu && /* @__PURE__ */ jsx(ContextMenu, { ...contextMenu, onDismiss: closeContextMenu }), $[41] = contextMenu, $[42] = t19) : t19 = $[42];
  let t20;
  $[43] !== dragGroupRect || $[44] !== dragInsertPosition || $[45] !== dragMinimapTransition || $[46] !== dragShowMinimapPrompt || $[47] !== isDragging ? (t20 = isDragging && !dragMinimapTransition && /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  ] }), $[43] = dragGroupRect, $[44] = dragInsertPosition, $[45] = dragMinimapTransition, $[46] = dragShowMinimapPrompt, $[47] = isDragging, $[48] = t20) : t20 = $[48];
  let t21;
  $[49] !== dragSkeleton || $[50] !== isDragging ? (t21 = isDragging && dragSkeleton && /* @__PURE__ */ jsx(OverlayDragPreview, { skeleton: dragSkeleton }), $[49] = dragSkeleton, $[50] = isDragging, $[51] = t21) : t21 = $[51];
  let t22;
  $[52] !== elementsToRender || $[53] !== t15 || $[54] !== t16 || $[55] !== t17 || $[56] !== t18 || $[57] !== t19 || $[58] !== t20 || $[59] !== t21 || $[60] !== zIndex ? (t22 = /* @__PURE__ */ jsxs(Root, { "data-fading-out": t15, "data-overlays": t16, ref: setRootElement, $zIndex: zIndex, children: [
    t17,
    t18,
    t19,
    elementsToRender,
    t20,
    t21
  ] }), $[52] = elementsToRender, $[53] = t15, $[54] = t16, $[55] = t17, $[56] = t18, $[57] = t19, $[58] = t20, $[59] = t21, $[60] = zIndex, $[61] = t22) : t22 = $[61];
  let t23;
  $[62] !== comlink || $[63] !== t22 ? (t23 = /* @__PURE__ */ jsx(SharedStateProvider, { comlink, children: t22 }), $[62] = comlink, $[63] = t22, $[64] = t23) : t23 = $[64];
  let t24;
  $[65] !== comlink || $[66] !== t23 ? (t24 = /* @__PURE__ */ jsx(PreviewSnapshotsProvider, { comlink, children: t23 }), $[65] = comlink, $[66] = t23, $[67] = t24) : t24 = $[67];
  let t25;
  $[68] !== comlink || $[69] !== elements || $[70] !== t24 ? (t25 = /* @__PURE__ */ jsx(SchemaProvider, { comlink, elements, children: t24 }), $[68] = comlink, $[69] = elements, $[70] = t24, $[71] = t25) : t25 = $[71];
  let t26;
  $[72] !== rootElement || $[73] !== t25 ? (t26 = /* @__PURE__ */ jsx(LayerProvider, { children: /* @__PURE__ */ jsx(PortalProvider, { element: rootElement, children: t25 }) }), $[72] = rootElement, $[73] = t25, $[74] = t26) : t26 = $[74];
  let t27;
  $[75] !== t14 || $[76] !== t26 ? (t27 = /* @__PURE__ */ jsx(ThemeProvider, { scheme: t14, theme: studioTheme, tone: "transparent", children: t26 }), $[75] = t14, $[76] = t26, $[77] = t27) : t27 = $[77];
  let t28;
  return $[78] !== comlink || $[79] !== t27 ? (t28 = /* @__PURE__ */ jsx(TelemetryProvider, { comlink, children: t27 }), $[78] = comlink, $[79] = t27, $[80] = t28) : t28 = $[80], t28;
}
function _temp0(e_1) {
...
const VisualEditing = (props) => {
  ...
  let t5;
  $[5] !== comlink || $[6] !== comlinkStatus || $[7] !== components || $[8] !== inFrame || $[9] !== inPopUp || $[10] !== onPerspectiveChange || $[11] !== plugins || $[12] !== zIndex ? (t5 = inFrame !== null && inPopUp !== null && /* @__PURE__ */ jsx(Overlays, { comlink, comlinkStatus, componentResolver: components, onPerspectiveChange, plugins, inFrame, inPopUp, zIndex }), $[5] = comlink, $[6] = comlinkStatus, $[7] = components, $[8] = inFrame, $[9] = inPopUp, $[10] = onPerspectiveChange, $[11] = plugins, $[12] = zIndex, $[13] = t5) : t5 = $[13];
  let t6;
  $[14] !== comlink || $[15] !== history || $[16] !== refresh ? (t6 = comlink && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(History, { comlink, history }),
    /* @__PURE__ */ jsx(Meta, { comlink }),
    refresh && /* @__PURE__ */ jsx(Refresh, { comlink, refresh })
  ] }), $[14] = comlink, $[15] = history, $[16] = refresh, $[17] = t6) : t6 = $[17];
  let t7;
  $[18] !== t5 || $[19] !== t6 ? (t7 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t5,
    t6
  ...
  if (portal === !1 || !portalElement)
    return children;
  let t8;
  return $[21] !== children || $[22] !== portalElement ? (t8 = createPortal(children, portalElement), $[21] = children, $[22] = portalElement, $[23] = t8) : t8 = $[23], t8;
};
